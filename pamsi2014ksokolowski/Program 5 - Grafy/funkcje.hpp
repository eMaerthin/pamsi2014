...
//Liczenie silni z liczby n
int silnia(int n);
//Liczenie wartosci symbolu Newtona
double symbol_newtona(int g, int d);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Losowanie prawdopodobienstwa 3 roznymi sposobami na podstawie liczby n. 
double wylosuj_prawdop_log2(int n);
double wylosuj_prawdop_min2(int n);
double wylosuj_prawdop_min3(int n);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Funkcja udostepniajaca prosty interfejs uzytkownika w celu: wczytywania, zapisywania grafow, tworzenia MST wybranym
//algorytmem, wyswietlanie grafu w formie listy lub tablicy.
void menu();
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//Dwie ponizsze funkcje sortuja tablice (przyslana jako wskaznik  na jej poczatek) algorytmem quicksort
template <class TYP>
